...
## What's new in v3.6.6 Special Edition
...
Full list: [`CHANGELOG.md`](CHANGELOG.md). Release copy: [`docs/releases/RELEASE_NOTES_v3.6.6.md`](docs/releases/RELEASE_NOTES_v3.6.6.md).
...
| `windo mesh [--json]` | **v3.6.6+** Read-only Operator Mesh preview: modules, recipes, extras, launchpad/tray assets, and export readiness. |

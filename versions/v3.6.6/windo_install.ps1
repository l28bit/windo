<# =====================================================================
WINDO v3.6.6 Special Edition Installer
    ...
    function _windo_help_topics {
        return @(
            ...
            [pscustomobject]@{
                ...
                Syntax      = @("windo mesh [--json]")
                Description = "Read-only inventory that joins modules, recipes, extras, launchpad/tray assets, and export readiness into one platform view."
                Notes       = "Does not fetch remote extras, start launchpad, write exports, or run elevated commands. It is a V4 preparation view."
                Examples    = @("windo mesh", "windo mesh --json")
            },
            [pscustomobject]@{
                Name        = "prompt"
                Category    = "Shell Experience"

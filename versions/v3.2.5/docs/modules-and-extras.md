...
For the **full framework-wave checklist** (modules, recipes, prompt, extras, dev, session, keybindings doctor), see **[`framework-wave.md`](framework-wave.md)**. For **AI / agent CLI** credential hygiene (**`windo ai`**), see **[`ai-bridge.md`](ai-bridge.md)**.

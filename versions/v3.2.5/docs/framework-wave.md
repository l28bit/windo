...
Not part of the original tier list, but aligned with the same **trust-bounded** philosophy: [`ai-bridge.md`](ai-bridge.md) and **`windo ai status`** / **`windo ai doctor`** (read-only env **name** visibility; no API calls, no secret storage).

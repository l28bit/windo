<# =====================================================================
WINDO v3.2.8 Release-Hardened Installer
...
$WindoBuiltinVerbs = @(
    'help', 'last', 'stats', 'history', 'report', 'dashboard', 'export', 'self-update', 'version',
...
"@
    ...
    function _windo_verify_installer_sha256_optional([string]$Path) {
        ...
        try {
            ...
            $expect = _windo_normalize_published_installer_sha256 -Text $wr.Content
        } catch {
            return
        }

<# =====================================================================
WINDO v3.6.7 Special Edition Installer
    ...
    function _windo_help_topics {
        return @(
            ...
            [pscustomobject]@{
                ...
                Syntax      = @("windo mesh [--json]", "windo mesh --html [--output path|--output=path]", "windo mesh --open")
                Description = "Read-only inventory and optional local cockpit HTML that joins modules, recipes, extras, launchpad/tray assets, and export readiness into one platform view."
                ...
                Examples    = @("windo mesh", "windo mesh --json", "windo mesh --html", "windo mesh --open")
            },
            [pscustomobject]@{
                Name        = "prompt"
                Category    = "Shell Experience"

...
## What's new in v5.1.1 Exodus Limited Edition
...
Full list: [`CHANGELOG.md`](CHANGELOG.md). Release copy: [`docs/releases/RELEASE_NOTES_v5.1.1.md`](docs/releases/RELEASE_NOTES_v5.1.1.md).
...
| `windo center [status\|open\|tray\|actions\|preview\|run\|queue\|execute-next\|next\|execute\|history\|signal]` | **v5.0.0+ / v5.1.0+** PowerShell-native Command Center unifying tray, control, surface, motion, signal, trust, recipes, modules, extras, audit, and export. |

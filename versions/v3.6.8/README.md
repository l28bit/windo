...
## What's new in v3.6.8 Special Edition
...
Full list: [`CHANGELOG.md`](CHANGELOG.md). Release copy: [`docs/releases/RELEASE_NOTES_v3.6.8.md`](docs/releases/RELEASE_NOTES_v3.6.8.md).
...
| `windo mesh [doctor] [--json] [--html [--output path\|--output=path]] [--open]` | **v3.6.6+** Read-only Operator Mesh preview; **v3.6.7+** adds branded local cockpit HTML/open mode; **v3.6.8+** adds readiness scoring with `windo mesh doctor`. |

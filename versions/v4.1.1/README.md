...
## What's new in v4.1.1 Special Edition
...
Full list: [`CHANGELOG.md`](CHANGELOG.md). Release copy: [`docs/releases/RELEASE_NOTES_v4.1.1.md`](docs/releases/RELEASE_NOTES_v4.1.1.md).

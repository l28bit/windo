<# =====================================================================
WINDO v4.0.1 Special Edition Installer
...
$WindoBuiltinVerbs = @(
    ...
    'theme', 'output', 'upgrade', 'install-latest', 'uninstall', 'remove', 'profile', 'keybindings', 'completion', 'roadmap', 'syntax', 'mesh',
    'modules', 'recipes', 'prompt', 'extras', 'dev', 'session', 'ai', 'repair', 'venv', 'pkg', 'run'
)
...
function Write-WindoEditionBanner {
    ...
    Write-Host "  deliberate elevation | audit chain | compact shell | operator visuals" -ForegroundColor DarkGray
    Write-Host ""
}
...
function __windo_completion_specs {
    @{
        help = @('version','install-latest','source','trust','explain','syntax','mesh','completion','output','keybindings','recipes','venv','pkg','launchpad','preflight','dashboard','integrity','verify','config','profile','modules','extras','ai','repair')

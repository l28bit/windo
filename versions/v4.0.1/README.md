...
## What's new in v4.0.1 Special Edition
...
Full list: [`CHANGELOG.md`](CHANGELOG.md). Release copy: [`docs/releases/RELEASE_NOTES_v4.0.1.md`](docs/releases/RELEASE_NOTES_v4.0.1.md).

<p align="center">
  <img src="brand/assets/transparent/logos/wordmark-tagline.png" alt="WINDO wordmark" width="58%">
</p>

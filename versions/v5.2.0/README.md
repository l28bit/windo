...
## What's new in v5.2.0 Exodus Limited Edition
...
Full list: [`CHANGELOG.md`](CHANGELOG.md). Release copy: [`docs/releases/RELEASE_NOTES_v5.2.0.md`](docs/releases/RELEASE_NOTES_v5.2.0.md).
...
| `windo center [status\|open\|tray\|panel\|actions\|preview\|run\|queue\|execute-next\|next\|execute\|history\|signal]` | **v5.0.0+ / v5.2.0+** PowerShell-native Command Center unifying tray, native panel, control, surface, motion, signal, trust, recipes, modules, extras, audit, and export. |

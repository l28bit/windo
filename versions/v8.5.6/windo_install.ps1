...
$WindoBuiltinVerbs = @(
    'help', '?', 'last', 'stats', 'history', 'report', 'dashboard', 'preflight', 'health', 'check', 'launchpad', 'export', 'self-update', 'version',
...
"@
    ...
    function _windo_new_command_plan([object[]]$Parts) {
        ...
        { $_ -in @("version", "config", "context", "profile", "roadmap", "preflight", "dashboard", "integrity", "verify", "session", "doctor", "runner", "log", "history", "stats", "backups", "modules", "extras", "prompt", "ai", "help", "motion", "surface", "control", "signal", "center", "health", "check", "status", "contract", "source") } {

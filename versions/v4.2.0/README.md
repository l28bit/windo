...
## What's new in v4.2.0 Special Edition
...
Full list: [`CHANGELOG.md`](CHANGELOG.md). Release copy: [`docs/releases/RELEASE_NOTES_v4.2.0.md`](docs/releases/RELEASE_NOTES_v4.2.0.md).

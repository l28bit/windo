...
## What's new in v5.3.0 Exodus Limited Edition
...
Full list: [`CHANGELOG.md`](CHANGELOG.md). Release copy: [`docs/releases/RELEASE_NOTES_v5.3.0.md`](docs/releases/RELEASE_NOTES_v5.3.0.md).

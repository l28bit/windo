<# =====================================================================
WINDO v5.3.0 Limited Edition Installer
...
$WindoBuiltinVerbs = @(
    ...
    'theme', 'output', 'motion', 'surface', 'control', 'signal', 'center', 'studio', 'edition', 'upgrade', 'install-latest', 'uninstall', 'remove', 'profile', 'keybindings', 'completion', 'roadmap', 'syntax', 'mesh',
...
function __windo_completion_specs {
    @{
        help = @('version','install-latest','source','trust','scan','vault','sshx','crypto','explain','syntax','mesh','completion','output','motion','surface','control','signal','center','studio','edition','keybindings','recipes','venv','pkg','launchpad','preflight','dashboard','integrity','verify','config','profile','modules','extras','ai','repair')
        ...
        control = @('status','prime','actions','preview','queue','run','execute-next','next','execute','inspect','cancel','history','pulse','demo','clear','surface-status','surface-prime','surface-panel','power-studio','center-status','source-status','verify-audit','surface-doctor','surface-repair','scan-home','vault-status','crypto-status','venv-status','sshx-status','recipes-list','pkg-status','launchpad-tray','workbench-html','edition-open','motion-pulse','profile-doctor','trust-online','preflight','install-latest','--json')
        signal = @('status','timeline','last','export','open','html','--html','--open','--output','--json')
        center = @('status','open','tray','panel','surface','studio','wizard','power','actions','preview','run','queue','execute-next','next','execute','history','signal','surface-status','surface-prime','surface-panel','power-studio','center-status','source-status','verify-audit','surface-doctor','surface-repair','scan-home','vault-status','crypto-status','venv-status','sshx-status','recipes-list','pkg-status','launchpad-tray','workbench-html','edition-open','motion-pulse','profile-doctor','trust-online','preflight','install-latest','--json')
        studio = @('--json')

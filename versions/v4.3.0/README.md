...
## What's new in v4.3.0 Special Edition
...
Full list: [`CHANGELOG.md`](CHANGELOG.md). Release copy: [`docs/releases/RELEASE_NOTES_v4.3.0.md`](docs/releases/RELEASE_NOTES_v4.3.0.md).
...
| `windo surface [status\|prime\|pulse]` | **v4.2.0+** Native surface readiness wiring: tray support, Windows Forms readiness, motion policy, profile prompt issues, and local surface manifest. |
| `windo control [status\|prime\|actions\|queue\|run\|pulse\|clear]` | **v4.3.0+** Local Windows control-plane wiring: manifest, curated tray/native action catalog, explicit JSON request queue, and visible-shell command executor for known WINDO actions. |

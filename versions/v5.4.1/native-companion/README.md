...
The WINDO v5 Command Center is PowerShell-native first. No compiled binary is required for install, update, tray, control-plane, Signal Deck, or center commands.
...
- Packaging/signing decisions belong to a later special release.

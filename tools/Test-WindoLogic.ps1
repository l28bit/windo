...
Assert-Equal ($installerSource.Contains('$WindoVersion = "5.1.0"') -eq $true) $true "installer version is 5.1.0"
Assert-Equal ($bootstrapSource.Contains("WINDO 5.1.0 Limited Edition bootstrap") -eq $true) $true "bootstrap banner is current"
...
Assert-Equal ($readmeSource.Contains("RELEASE_NOTES_v5.1.0.md") -eq $true) $true "README links v5.1.0 release notes"

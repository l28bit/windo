...
Assert-Equal ($installerSource.Contains('$WindoVersion = "5.0.0"') -eq $true) $true "installer version is 5.0.0"
Assert-Equal ($bootstrapSource.Contains("WINDO 5.0.0 Special Edition bootstrap") -eq $true) $true "bootstrap banner is current"
...
Assert-Equal ($readmeSource.Contains("RELEASE_NOTES_v5.0.0.md") -eq $true) $true "README links v5.0.0 release notes"

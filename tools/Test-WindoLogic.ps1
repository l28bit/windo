...
Assert-Equal ($installerSource.Contains('$WindoVersion = "4.0.0"') -eq $true) $true "installer version is 4.0.0"
Assert-Equal ($bootstrapSource.Contains("WINDO 4.0.0 Special Edition bootstrap") -eq $true) $true "bootstrap banner is current"
...
Assert-Equal ((Test-Path (Join-Path $Root "docs\releases\RELEASE_NOTES_v4.0.0.md")) -eq $true) $true "v4.0.0 release notes exist"
Assert-Equal ((Test-Path (Join-Path $Root "docs\v5-roadmap.md")) -eq $true) $true "v5 roadmap doc exists"
Assert-Equal ($readmeSource.Contains("RELEASE_NOTES_v4.0.0.md") -eq $true) $true "README links v4.0.0 release notes"
...
Assert-Equal ((Test-Path (Join-Path $Root "versions\v4.0.0\brand\assets\banners\banner-blue-left.png")) -eq $true) $true "v4.0.0 snapshot includes README banner asset"
